...
#include "../../../Bullet/include/LinearMath/btMatrix3x3.h"		Bullet nonsense
#endif
*/
...
//	float3x3 Adjugate() const;
	...
	operator btMatrix3x3() const { return btMatrix3x3(v[0][0], v[0][1], v[0][2], v[1][0], v[1][1], v[1][2], v[2][0], v[2][1], v[2][2]); }		Bullet nonsense
#endif
	*/
