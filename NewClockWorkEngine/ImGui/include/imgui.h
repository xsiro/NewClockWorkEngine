...
struct ImGuiViewport
{
   ...
   // ImVec2              GetWorkPos() { return ImVec2(Pos.x + WorkPos.x, Pos.y + WorkPos.y); }
   // ImVec2              GetWorkSize() { return ImVec2(Size.x - WorkPos.x + WorkSize.x, Size.y - WorkPos.y + WorkSize.y); } // This not clamped
};
